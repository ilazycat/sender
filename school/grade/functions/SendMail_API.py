...
class SendMail:
    #5YceTh1Nxf
    def __init__(self,sub = 'sub', content = 'content', mailTo = ['lpylzx1@qq.com'], mailHost = 'smtp.ym.163.com',mailUser = 'robot@lc4t.me', mailPassword = '5YceTh1Nxf', mailPosfix = 'lc4t.me'):
