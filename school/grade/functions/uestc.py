...
class TermStruct:
    ...
    def printAll(self):
        for i in range(0,self.__length__,1):
            ...
            print ("学期 共",end=' ')
            print (self.numberOfCources[i],end=' ')
            print ("门课 总学分",end=' ')
...
class Courcestruct:
    ...
    def add(self,cource, adjuster, makeup = 0):
        # print (cource)
        cource[0] = cource[0].encode('ascii').decode()
        # print (cource[0])
    ...
    def printCources(self):
        for i in range(0,self.count, 1):
            ...
            print (" --> ",)
            print (self.courceName[i].encode('utf-8').decode(),end=' ')
            print (self.courceType[i].encode('utf-8').decode())
            # print ("-------------------------------------------> ",)
            print ("----------------------> ",end=' ')
            print (self.courceCredit[i],end=' ')
            print ("学分",end=' ')
            print ("总评",end=' ')
            print (self.courceGrade[i],end=' ')
            print ("最终",end=' ')
            print (self.courceFinal[i],end=' ')
...
class GradeAnalyzer:
    ...
    def printCources(self):
        ...
        # for i in range(0,len(tempA),7 + isMakeup): #there is a bug to repair,I need set a adjuster
        #     print i
...
class UESTC:
    def __init__(self,username = 0,password = 0):
        ...
        if (username != 0):
            ...
            self.__inputUserName__ = input("UserName:")
            self.__inputPassWord__ = input("PassWord:")
    ...
    def getCources(self,getter = False):# error cannot use
        postData = urlencode(
            {
                'ignoreHead':'1',
                'setting.kind':'std',
...
if __name__ == '__main__':
    uestc = UESTC()
    print (uestc.getStatus())
    # print (uestc.getIndex(getter=True))
    # print (uestc.getEAS(getter=True))
    # print (uestc.getMyGrade(getter=True))
